    ...
    <body>
        ...
        <section class="section-cities" id="cities">
            ...
            <div class="row js--wp-3">
                <div class="col span-1-of-4 box">
                    <img src="ressources/img/lisbon-3.jpg" alt="Lisbon"/>  
                    <h3>Lisbonne</h3>
                ...
                <div class="col span-1-of-4 box">
                    <img src="ressources/img/berlin.jpg" alt="Berlin"/>  
                    <h3>Berlin</h3>
                    <div class="city-feature">
                        <i class="ion-ios-person icon-small"></i>
            ...
            <div class="row">
                <div class="col span-1-of-3">
                    <blockquote>
                        ...
                        <cite><img src="ressources/img/customer-1.jpg" alt="Client 1 photo"/>Alberto Duncan</cite>
                    </blockquote>                    
                </div>
                <div class="col span-1-of-3">
                    <blockquote>
                        Des repas bon marché, sains et savoureux, livrés directement chez moi. Nous avons beaucoup de livraison de nourriture ici à Lisbonne, mais personne ne s'approche même d'Omifood. Ma famille et moi sommes tellement amoureux!
                        <cite><img src="ressources/img/customer-2.jpg" alt="Client 2 photo"/>Joana Silva</cite>
                    </blockquote>                    
                </div>
                <div class="col span-1-of-3">
                    <blockquote>
                        Je cherchais un service de livraison de nourriture rapide et facile à San Franciso. J'ai essayé beaucoup d'entre eux et j'ai fini avec Omnifood. Meilleur service de livraison de nourriture dans la région de la baie. Continuez ce bon travail!
                        <cite><img src="ressources/img/customer-3.jpg" alt="Client 3 photo"/>Milton Chapman</cite>
                    </blockquote>                    
                </div>
            </div>        
        </section>
            ...
            <div class="form-box" id="form">
                ...
                <form method="post" action="mailer.php" class="contact-form">
                    <div class="row">
                        <?php 
                            if($_GET['success'] == 1) {
                                echo "<div class=\"form-messages success\">Merci! Votre message a été envoyé."+$name+"</div>";
                            } 
